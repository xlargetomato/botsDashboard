...
export default function SubscriptionSuccessPage() {
  ...
  // Check authentication status and fetch subscription details
  useEffect(() => {
    const checkAuth = async () => {
      try {
        // Try to get subscription details from session storage first
        ...
        // If no session storage data, try to authenticate and fetch from API
        ...
        if (response.ok) {
          ...
          if (subscriptionId) {
            try {
              ...
              // Create a fallback subscription object if API call fails
              if (subscriptionId) {
                setSubscription({
                  id: subscriptionId,
