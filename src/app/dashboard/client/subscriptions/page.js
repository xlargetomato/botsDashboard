...
export default function SubscriptionsPage() {
  ...
  const [activeTab, setActiveTab] = useState('subscriptions'); // Default to 'subscriptions' instead of 'plans'
    ...
    <MainLayout sidebar={<DashboardSidebar />}>
      <div className="max-w-7xl mx-auto">
        ...
        {activeTab === 'subscriptions' ? (
          <SubscriptionList subscriptions={userSubscriptions} setActiveTab={setActiveTab}/>
        ) : (
          <div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
