                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 focus:outline-none dark:bg-gray-700 dark:text-white font-cairo text-start ${isRtl ? 'text-right' : 'text-left'}"
